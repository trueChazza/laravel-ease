...
const dateTime$1 = options => {
	...
	if (options.showTimeZone) {
		end = ' UTC' + (options.local ? timeZone$1(date) : '');
	}
...
dateTime.exports = dateTime$1;
// TODO: Remove this for the next major release
dateTime.exports.default = dateTime$1;

var dateTime$2 = dateTime.exports;
    ...
    function start(configs) {
        ...
        watcher.on('event', event => {
            switch (event.code) {
                ...
                case 'END':
                    if (!silent && isTTY) {
                        loadConfigFile_js.stderr(`\n[${dateTime$2()}] waiting for changes...`);
                    }
            }
